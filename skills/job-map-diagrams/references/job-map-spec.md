...
- Every stage has a numeric `outside_product_percent` from 0 through 100. This estimates how much of the user's work in that stage occurs outside the product. Values above 50 render with a pale fill and dashed outline; values of exactly 50 or less render solid. The numeric estimate remains in the specification and is not printed on the card.
