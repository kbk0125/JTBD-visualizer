...
- Put `Time:` or `Drop-off:` directly beneath the title. Follow with one to five literal bullet glyphs and a Sources line. Separate Sources from activities by one blank line. Do not print the outside-product percentage on cards; communicate it only through the bar treatment and legend.
