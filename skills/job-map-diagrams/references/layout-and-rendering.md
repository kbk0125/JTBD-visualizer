...
- Put `Time:` or `Drop-off:` directly beneath the title. Follow with one to five literal bullet glyphs and a Sources line. Separate Sources from activities by one blank line.
...
- Render stage cards with watercolor style. Keep bars crisp and solid, icons crisp, and the summary header plain with a white surface and subtle gray border.
